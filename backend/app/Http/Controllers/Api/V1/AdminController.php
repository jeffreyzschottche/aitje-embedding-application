...
class AdminController extends Controller
{
    ...
    public function createUser(Request $request): JsonResponse
    {
        ...
        return response()->json([
            ...
            'user' => $this->serializeUser($user->load('gitConfiguration')->loadCount('documents')),
        ], 201);
    }

    public function updateGitConfig(Request $request, User $user): JsonResponse
    {
        $validated = $request->validate([
        ...
        $existing = GitConfiguration::where('user_id', $user->id)->first();
        ...
        $config = GitConfiguration::updateOrCreate(['user_id' => $user->id], $data);

        return response()->json([
            'message' => 'Git-configuratie opgeslagen.',
            'git_configuration' => $config,
            'user' => $this->serializeUser($user->fresh()->load('gitConfiguration')->loadCount('documents')),
        ]);
    }
    ...
    private function serializeUser(User $user): array
    {
        return [
            ...
            'git_configuration' => $user->gitConfiguration,
        ];
    }
}
